...
public class OrderDetailsTm {
    ...
    public OrderDetailsTm(String orderId, String itemCode, String itemDescription, String itemBrand, String itemCategory, double itemRam, double itemStorage, int qtyOnHand, double itemDiscount, double itemCost) {
