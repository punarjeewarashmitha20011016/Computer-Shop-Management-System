...
public class AddRepairTm {
    ...
    public AddRepairTm(String customerId, String repairId, int repairCount, String repairItemDescription, String repairItemType, String repairItemPart, double repairCost) {
