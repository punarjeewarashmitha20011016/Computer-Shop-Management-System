...
public class Item {
    ...
    public Item(String itemCode, String itemDescription, String itemBrand, String itemCategory, double itemRam, double itemStorage, int itemQty, double itemBuyingPrice, double itemUnitPrice) {
