...
public class RepairsFinishedDetails {
    ...
    public RepairsFinishedDetails() {
    }

    public RepairsFinishedDetails(String repairId,int repairCount, String repairItemDescription, String repairType, String repairPart, double repairCost) {
