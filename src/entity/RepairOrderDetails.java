...
public class RepairOrderDetails {
    ...
    public RepairOrderDetails() {
    }

    public RepairOrderDetails(String orderId, int repairCount, String repairItemDescription, String repairType, String repairPart, String repairStartDate, String repairFinishedDate, double repairItemPrice) {
