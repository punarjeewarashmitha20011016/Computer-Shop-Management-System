...
public class RepairsInProgress {
    ...
    public RepairsInProgress() {
    }

    public RepairsInProgress(String customerId, String repairId, String repairItemDescription, String repairStartDate, String repairEstimatedFinishingDate, double repairCost) {
