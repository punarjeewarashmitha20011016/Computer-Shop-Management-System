...
public class ItemDTO {
    ...
    public ItemDTO(String itemCode,String itemDescription,int itemQty,double itemUnitPrice){
    ...
    public ItemDTO(String itemCode, String itemDescription, String itemBrand, String itemCategory, double itemRam, double itemStorage, int itemQty, double itemBuyingPrice, double itemUnitPrice) {
        this.itemCode = itemCode;
        this.itemDescription = itemDescription;
