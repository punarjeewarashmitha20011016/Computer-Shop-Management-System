...
public class RepairsInProgressDTO {
    ...
    public RepairsInProgressDTO() {
    }
    public RepairsInProgressDTO(String customerId, String repairId, String repairItemDescription, String repairStartDate, String repairEstimatedFinishingDate, double repairCost) {
    ...
    public RepairsInProgressDTO(String customerId, String repairId, String repairItemDescription, String repairStartDate, String repairEstimatedFinishingDate, double repairCost,ArrayList<RepairListDetailsDTO>listDetails) {
        this.customerId = customerId;
        this.repairId = repairId;
        this.repairItemDescription = repairItemDescription;
        this.repairStartDate = repairStartDate;
        this.repairEstimatedFinishingDate = repairEstimatedFinishingDate;
        this.repairCost = repairCost;
        this.listDetailsArrayList=listDetails;
    }
