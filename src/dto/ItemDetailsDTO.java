...
public class ItemDetailsDTO {
    ...
    public ItemDetailsDTO(String itemCode, String itemDescription, String itemBrand, String itemCategory, double itemRam, double itemStorage, int itemQtyOnHand, Double itemDiscount, Double itemPrice) {
