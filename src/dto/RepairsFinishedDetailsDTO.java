...
public class RepairsFinishedDetailsDTO {
    ...
    public RepairsFinishedDetailsDTO() {
    }

    public RepairsFinishedDetailsDTO(String repairId,int repairCount, String repairItemDescription, String repairType, String repairPart, double repairCost) {
