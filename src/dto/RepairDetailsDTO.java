...
public class RepairDetailsDTO {
    ...
    public RepairDetailsDTO() {
    }

    public RepairDetailsDTO(String repairId,int repairCount, String repairItemDescription, String repairType, String repairPart, double repairCost) {
